...
using System.Linq;
using System.Web;
using U = CiwValidationApi.Utilities;


namespace CiwValidationApi.Validator
{
    public class Validate
    {
        public class EmployeeValidationRules : AbstractValidator<Person>
        {
            /// <summary>
            ...
            public EmployeeValidationRules()
            {
                ...
                {
                    RuleFor(employee => employee.PriorInvestigationDate)
                            .NotEmpty()
                ...
                When(e => (e.CitizenshipCountry.Equals("US")), () =>
                {
                    RuleFor(employee => employee.Citizen)
                        .Equal("Yes")
                ...
                //Port of Entry
                When(e => (e.Citizen.Equals("No") && !e.CitizenshipCountry.Equals("US")), () =>
                {
                ...
                //Citizenship Country
                RuleFor(employee => employee.CitizenshipCountry)
                        .NotEmpty()
